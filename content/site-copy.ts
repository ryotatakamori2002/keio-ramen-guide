...
export const copy = {
  ...
  post: {
    ...
    loginTitle: "投稿にはログインが必要です",
    loginBody: "見るだけならログインは要りません。食べた一杯を記録するにはアカウントを作成してください。",
    login: "ログイン",
    signup: "アカウントを作る",
    ...
    fields: {
      ...
      shopSearchPlaceholder: "店名で検索（例：武蔵家）",
      shopNotFound: "見つからない場合は、新しい店として投稿できます。",
      newShopToggle: "新しい店として投稿",
      backToSearch: "検索に戻る",
      selected: "選択中",
      change: "変更",
      newShopName: "店名",
      newShopArea: "エリア",
      newShopMemo: "メモ",
      newShopMemoPlaceholder: "任意。場所の目印など。",
      isPublic: "この投稿を公開する",
      photo: "写真",
  ...
  auth: {
    disabledTitle: "準備中",
    disabledBody: "ログイン機能はSupabaseの設定後に有効になります。手順はREADMEを参照してください。",
    login: {
      eyebrow: "Login",
      title: "ログイン",
      subtitle: "投稿にはログインが必要です。見るだけならログインは要りません。",
      email: "メールアドレス",
      password: "パスワード",
      submit: "ログイン",
      submitting: "確認中…",
    ...
    signup: {
      eyebrow: "Sign up",
      title: "アカウントを作る",
      subtitle: "食べた一杯を記録できるようになります。",
      handle: "ユーザーID",
      handleHint: "半角英数字と _（例：ryota）",
      displayName: "表示名",
      email: "メールアドレス",
      ...
      submitting: "作成中…",
      toLogin: "ログインはこちら",
      checkEmail: "確認メールを送りました。メール内のリンクを開いてからログインしてください。",
      error: "登録に失敗しました。入力内容を確認してください。",
    },
  },
  ...
  me: {
    eyebrow: "My Log",
    title: "自分のラーメンログ",
    loginPrompt: "ログインすると、自分が食べた一杯の記録が見られます。",
    login: "ログイン",
    logout: "ログアウト",
    empty: "まだ投稿はありません。",
    addLog: "記録を追加する",
    publicProfile: "公開プロフィール",
    stats: { posts: "投稿", shops: "行った店", areas: "エリア", genres: "ジャンル" },
    postsTitle: "投稿した一杯",
    reviewing: "確認中",
    private: "非公開",
  },
